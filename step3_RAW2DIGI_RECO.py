...
process.GEMHitAnalyzer = cms.EDAnalyzer("GEMHitAnalyzer",
                                        gemDigi = cms.InputTag("muonGEMDigis"),
                                        gemRecHit = cms.InputTag("gemRecHits"),
                                        ) 

# Path and EndPath definitions
process.raw2digi_step = cms.Path(process.RawToDigi)
process.reconstruction_step = cms.Path(process.reconstruction)
process.analysis_step = cms.Path(process.GEMHitAnalyzer)
process.endjob_step = cms.EndPath(process.endOfProcess)
process.FEVTDEBUGHLToutput_step = cms.EndPath(process.FEVTDEBUGHLToutput)

# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.reconstruction_step,process.analysis_step,process.endjob_step,process.FEVTDEBUGHLToutput_step)
